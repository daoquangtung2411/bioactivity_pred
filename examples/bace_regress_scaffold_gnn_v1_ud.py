...
def run_gcn_tuning(train_data, valid_data, test_data, encoder, max_evals=100):
    ...
    train_dataset = generate_graph_dataset(train_data, 'SMILES', 'pIC50', encoder=encoder)
    valid_dataset = generate_graph_dataset(valid_data, 'SMILES', 'pIC50', encoder=encoder)
    test_dataset = generate_graph_dataset(test_data, 'SMILES', 'pIC50', encoder=encoder)
    ...
    merge_dataset = generate_graph_dataset(merge_data, 'SMILES', 'pIC50', encoder=encoder)
...
with open('results/bace_regress_gnn_scaff_v1.txt', 'w') as file:
...
with open('results/bace_regress_gnn_scaff_v2.txt', 'w') as file:
    file.write(f'BACE classfication\n')
    file.write('ANN Classifier results:\n')
    # file.write(f'Best params: {best_ann_params}')
    file.write(tabulate(result_body, headers=result_header, tablefmt='grid'))
...
with open('results/bace_regress_gnn_scaff_v3.txt', 'w') as file:
    file.write(f'BACE classfication\n')
    file.write('ANN Classifier results:\n')
    # file.write(f'Best params: {best_ann_params}')
    file.write(tabulate(result_body, headers=result_header, tablefmt='grid'))
...
with open('results/bace_regress_gnn_scaff_v4.txt', 'w') as file:
    file.write(f'BACE classfication\n')
    file.write('ANN Classifier results:\n')
    # file.write(f'Best params: {best_ann_params}')
    file.write(tabulate(result_body, headers=result_header, tablefmt='grid'))
...
with open('results/bace_regress_gnn_scaff_v5.txt', 'w') as file:
    file.write(f'BACE classfication\n')
    file.write('ANN Classifier results:\n')
    # file.write(f'Best params: {best_ann_params}')
    file.write(tabulate(result_body, headers=result_header, tablefmt='grid'))
